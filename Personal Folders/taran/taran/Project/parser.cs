...
// DateTime: 26/05/2017 9:19:48 PM
// UserName: Tarandeep
// Input file <parser.y - 26/05/2017 9:07:26 PM>
...
{
  // Verbatim content from parser.y - 26/05/2017 9:07:26 PM
#line 4 "parser.y"
	public static AST.CompilationUnit Root;
#line default
  // End verbatim content from parser.y - 26/05/2017 9:07:26 PM
...
#pragma warning restore 649
  ...
  private static string[] nonTerms = new string[] {
      ...
      "PostDecrementExpression", "Primary", "PrimaryNoNewArray", "LocalVariableDeclaration", 
      "LocalVariableDeclarationStatement", "AssignmentOperator", "CompilationUnit", 
      "$accept", "VariableModifiers", "VariableInitializer", "Dims_opt", "Dims", 
      };

  static Parser() {
    states[0] = new State(-26,new int[]{-61,1,-1,3,-2,4,-4,5});
    states[1] = new State(new int[]{128,2});
    states[2] = new State(-1);
    states[3] = new State(-2);
    states[4] = new State(-3);
    states[5] = new State(new int[]{141,6,167,91,166,92,150,93,170,94},new int[]{-3,113});
    states[6] = new State(new int[]{130,7});
    states[7] = new State(new int[]{123,9},new int[]{-8,8});
    states[8] = new State(-4);
    states[9] = new State(-6,new int[]{-9,10});
    states[10] = new State(new int[]{125,11,59,127,180,-26,159,-26,135,-26,130,-26,167,-26,166,-26,150,-26,170,-26},new int[]{-7,12,-6,13,-5,14,-4,15});
    states[11] = new State(-5);
    states[12] = new State(-7);
    states[13] = new State(-8);
    states[14] = new State(-9);
    states[15] = new State(new int[]{180,125,159,79,135,80,130,90,167,91,166,92,150,93,170,94},new int[]{-10,16,-3,113,-11,114,-12,126,-13,77,-15,78,-14,81,-16,82,-17,83});
    states[16] = new State(new int[]{123,19,59,112},new int[]{-24,17,-25,18});
    states[17] = new State(-11);
    states[18] = new State(-13);
    states[19] = new State(-17,new int[]{-23,20});
    states[20] = new State(new int[]{125,21,159,79,135,80,130,85,167,91,166,92,150,93,170,94,123,19,155,105},new int[]{-26,22,-59,23,-58,24,-12,26,-13,77,-15,78,-14,81,-16,82,-17,83,-63,86,-3,95,-27,96,-29,97,-25,98,-30,99,-31,100,-34,102,-35,67,-39,103,-28,104});
    ...
    states[26] = new State(new int[]{130,71},new int[]{-32,27,-22,28,-21,32});
    states[27] = new State(-21);
    states[28] = new State(-37,new int[]{-33,29});
    states[29] = new State(new int[]{44,30,59,-36});
    states[30] = new State(new int[]{130,71},new int[]{-22,31,-21,32});
    states[31] = new State(-38);
    states[32] = new State(new int[]{61,33,44,-39,59,-39});
    states[33] = new State(new int[]{129,58,130,60},new int[]{-64,34,-36,35,-37,36,-40,37,-41,38,-42,39,-43,40,-44,41,-45,42,-46,43,-47,44,-48,64,-49,47,-50,63,-51,50,-52,51,-53,52,-56,55,-57,56,-38,57,-39,65,-54,61,-55,62,-34,66,-35,67});
    ...
    states[45] = new State(new int[]{129,58,130,60},new int[]{-48,46,-49,47,-50,63,-51,50,-52,51,-53,52,-56,55,-57,56,-38,57,-39,59,-54,61,-55,62});
    states[46] = new State(-62);
    states[47] = new State(new int[]{43,48,60,-63,44,-63,59,-63,41,-63});
    states[48] = new State(new int[]{129,58,130,60},new int[]{-50,49,-51,50,-52,51,-53,52,-56,55,-57,56,-38,57,-39,59,-54,61,-55,62});
    states[49] = new State(-65);
    states[50] = new State(-66);
    states[51] = new State(-67);
    states[52] = new State(new int[]{212,53,213,54,43,-68,60,-68,44,-68,59,-68,41,-68});
    ...
    states[65] = new State(new int[]{212,-70,213,-70,43,-70,60,-70,44,-70,59,-70,41,-70,61,-51});
    states[66] = new State(-78);
    states[67] = new State(new int[]{61,70},new int[]{-60,68});
    states[68] = new State(new int[]{129,58,130,60},new int[]{-36,69,-37,36,-40,37,-41,38,-42,39,-43,40,-44,41,-45,42,-46,43,-47,44,-48,64,-49,47,-50,63,-51,50,-52,51,-53,52,-56,55,-57,56,-38,57,-39,65,-54,61,-55,62,-34,66,-35,67});
    states[69] = new State(-50);
    states[70] = new State(-52);
    states[71] = new State(new int[]{91,74,61,-91,44,-91,59,-91,41,-91,159,-91,135,-91,130,-91,167,-91,166,-91,150,-91,170,-91},new int[]{-65,72,-66,73});
    states[72] = new State(-90);
    states[73] = new State(-92);
    states[74] = new State(new int[]{93,75});
    states[75] = new State(new int[]{91,74,61,-93,44,-93,59,-93,41,-93,159,-93,135,-93,130,-93,167,-93,166,-93,150,-93,170,-93,123,-93},new int[]{-66,76});
    ...
    states[83] = new State(new int[]{91,74},new int[]{-66,84});
    states[84] = new State(-88);
    states[85] = new State(new int[]{91,-89,61,-80});
    states[86] = new State(new int[]{159,79,135,80,130,90,167,91,166,92,150,93,170,94},new int[]{-12,87,-3,89,-13,77,-15,78,-14,81,-16,82,-17,83});
    states[87] = new State(new int[]{130,71},new int[]{-32,88,-22,28,-21,32});
    ...
    states[103] = new State(-51);
    states[104] = new State(-43);
    states[105] = new State(new int[]{40,106});
    states[106] = new State(new int[]{129,58,130,60},new int[]{-36,107,-37,36,-40,37,-41,38,-42,39,-43,40,-44,41,-45,42,-46,43,-47,44,-48,64,-49,47,-50,63,-51,50,-52,51,-53,52,-56,55,-57,56,-38,57,-39,65,-54,61,-55,62,-34,66,-35,67});
    states[107] = new State(new int[]{41,108});
    states[108] = new State(new int[]{123,19,130,60,155,105},new int[]{-27,109,-29,97,-25,98,-30,99,-31,100,-34,102,-35,67,-39,103,-28,104});
    states[109] = new State(new int[]{147,110,125,-48,159,-48,135,-48,130,-48,167,-48,166,-48,150,-48,170,-48,123,-48,155,-48});
    states[110] = new State(new int[]{123,19,130,60,155,105},new int[]{-27,111,-29,97,-25,98,-30,99,-31,100,-34,102,-35,67,-39,103,-28,104});
    states[111] = new State(-49);
    states[112] = new State(-14);
    states[113] = new State(-25);
    states[114] = new State(new int[]{130,116},new int[]{-18,115});
    states[115] = new State(-12);
    states[116] = new State(new int[]{40,117});
    states[117] = new State(-84,new int[]{-19,118});
    states[118] = new State(new int[]{41,119,159,-26,135,-26,130,-26,167,-26,166,-26,150,-26,170,-26},new int[]{-20,121,-4,122});
    states[119] = new State(new int[]{91,74,123,-91,59,-91},new int[]{-65,120,-66,73});
    states[120] = new State(-83);
    states[121] = new State(-85);
    states[122] = new State(new int[]{159,79,135,80,130,90,167,91,166,92,150,93,170,94},new int[]{-12,123,-3,113,-13,77,-15,78,-14,81,-16,82,-17,83});
    states[123] = new State(new int[]{130,71},new int[]{-21,124});
    states[124] = new State(-86);
    ...
    rules[1] = new Rule(-62, new int[]{-61,128});
    rules[2] = new Rule(-61, new int[]{-1});
    ...
    rules[18] = new Rule(-26, new int[]{-59});
    rules[19] = new Rule(-26, new int[]{-27});
    rules[20] = new Rule(-59, new int[]{-58,59});
    rules[21] = new Rule(-58, new int[]{-12,-32});
    rules[22] = new Rule(-58, new int[]{-63,-12,-32});
    rules[23] = new Rule(-63, new int[]{-3});
    rules[24] = new Rule(-63, new int[]{-63,-3});
    ...
    rules[40] = new Rule(-22, new int[]{-21,61,-64});
    rules[41] = new Rule(-64, new int[]{-36});
    ...
    rules[50] = new Rule(-34, new int[]{-35,-60,-36});
    rules[51] = new Rule(-35, new int[]{-39});
    rules[52] = new Rule(-60, new int[]{61});
    ...
    rules[69] = new Rule(-53, new int[]{-56});
    rules[70] = new Rule(-53, new int[]{-39});
    rules[71] = new Rule(-53, new int[]{-54});
    rules[72] = new Rule(-53, new int[]{-55});
    rules[73] = new Rule(-54, new int[]{-53,212});
    rules[74] = new Rule(-55, new int[]{-53,213});
    rules[75] = new Rule(-56, new int[]{-57});
    rules[76] = new Rule(-57, new int[]{-38});
    rules[77] = new Rule(-37, new int[]{-40});
    rules[78] = new Rule(-37, new int[]{-34});
    rules[79] = new Rule(-38, new int[]{129});
    rules[80] = new Rule(-39, new int[]{130});
    rules[81] = new Rule(-11, new int[]{180});
    rules[82] = new Rule(-11, new int[]{-12});
    rules[83] = new Rule(-18, new int[]{130,40,-19,41,-65});
    rules[84] = new Rule(-19, new int[]{});
    rules[85] = new Rule(-19, new int[]{-19,-20});
    rules[86] = new Rule(-20, new int[]{-4,-12,-21});
    rules[87] = new Rule(-14, new int[]{-16});
    rules[88] = new Rule(-16, new int[]{-17,-66});
    rules[89] = new Rule(-17, new int[]{130});
    rules[90] = new Rule(-21, new int[]{130,-65});
    rules[91] = new Rule(-65, new int[]{});
    rules[92] = new Rule(-65, new int[]{-66});
    rules[93] = new Rule(-66, new int[]{91,93});
    rules[94] = new Rule(-66, new int[]{91,93,-66});
  }
...
#line default
        break;
      case 75: // Primary -> PrimaryNoNewArray
#line 321 "parser.y"
                              { CurrentSemanticValue.expression = ValueStack[ValueStack.Depth-1].expression; }
#line default
        break;
      case 76: // PrimaryNoNewArray -> Literal
#line 325 "parser.y"
                      { CurrentSemanticValue.expression = ValueStack[ValueStack.Depth-1].expression; }
#line default
        break;
      case 77: // AssignmentExpression -> ConditionalExpression
#line 329 "parser.y"
                                 { CurrentSemanticValue.expression = ValueStack[ValueStack.Depth-1].expression; }
#line default
        break;
      case 78: // AssignmentExpression -> Assignment
#line 330 "parser.y"
                        { CurrentSemanticValue.expression = ValueStack[ValueStack.Depth-1].expression; }
#line default
        break;
      case 79: // Literal -> IntegerLiteral
#line 334 "parser.y"
                           { CurrentSemanticValue.expression = new AST.NumberExpression(ValueStack[ValueStack.Depth-1].num); }
#line default
        break;
      case 80: // ExpressionName -> Identifier
#line 338 "parser.y"
...
#line default
        break;
      case 83: // MethodDeclarator -> Identifier, '(', FormalParameterList, ')', Dims_opt
#line 347 "parser.y"
...
#line default
        break;
      case 84: // FormalParameterList -> /* empty */
#line 351 "parser.y"
                         { CurrentSemanticValue.parameters = new List<AST.Parameter>(); }
#line default
        break;
      case 85: // FormalParameterList -> FormalParameterList, FormalParameter
#line 352 "parser.y"
...
#line default
        break;
      case 86: // FormalParameter -> Modifiers, UnannType, VariableDeclaratorId
#line 356 "parser.y"
...
#line default
        break;
      case 87: // UnannReferenceType -> UnannArrayType
#line 360 "parser.y"
                           { CurrentSemanticValue.programType = ValueStack[ValueStack.Depth-1].programType; }
#line default
        break;
      case 88: // UnannArrayType -> UnannTypeVariable, Dims
#line 364 "parser.y"
                                 { CurrentSemanticValue.programType = ValueStack[ValueStack.Depth-2].programType; }
#line default
        break;
      case 89: // UnannTypeVariable -> Identifier
#line 368 "parser.y"
                        { CurrentSemanticValue.programType = new AST.IdentifierType(); }
#line default
        break;
      case 90: // VariableDeclaratorId -> Identifier, Dims_opt
#line 372 "parser.y"
