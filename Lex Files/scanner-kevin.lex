...
FloatingPointLiteral					{DecimalFloatingPointLiteral}|{HexadecimalFloatingPointLiteral}	//kevin
...
{FloatingPointLiteral}					{ yylval.name = yytext; return (int)Tokens.FloatingPointLiterals; } // kevin
